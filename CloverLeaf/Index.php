...
<div class="ui grid stackable relaxed inverted feature segment" style="padding-top: 30px;">
    ...
    <div class="three column row">
        ...
        <div class="column">
            <div class="ui segment">
                <div class="image">
                    <img src="Imgs/PathwayBefore1.jpg" />
                </div>
                <div class="content">
                <p>
                    <strong>The Before:</strong> We survey the landscape and gather the vision of the homeowner.
                    With this, we can then let our creative directors design the yard of their dreams.
                </p>
                </div>
            </div> 
        </div>
        <div class="column">
            <div class="ui segment">
                <div class="image">
                    <img src="Imgs/PathwayDuring.jpg" />
                </div>
                <div class="content">
                <p>
                    <strong>The During:</strong> Once the design is finalize we let our skilled laborers get to work.
                    Their experience in the handling of the materials ensure implementation.
                </p>
                </div>
            </div> 
        </div>
        <div class="column">
            <div class="ui segment">
                <div class="image">
                    <img src="Imgs/PathwayAfter1.jpg" />
                </div>
                <div class="content">
                <p>
                    <strong>The Reveal:</strong> After everything has been completed we put the finishing touches on.
                    The homeowners get see their new yard and we all share in the joyous moment!
                </p>
                </div>
            </div> 
        </div>
    ...
    <div class="ui dividing block black huge header">
        <a class="icon item">
        ...
        <div class="column row">
			...
			<param value="controls=true&amp;file=http://www.cloverleaflandscaping.com/new/wp-content/uploads/2013/05/Cloverleaf-Landscaping-and-Retail-Center.mp4" name="flashvars">			
                    ...
                    <div class="content">
                        ...
                        <p class="description">
                            Check out our television ad further describing exactly what we can do for you and your home!                             
                        </p>
                    </div>
                </div>
            </div>
        </div>
        something about being made by students   
