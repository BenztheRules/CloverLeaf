...
<body>
    <a name="LilyTop"></a>
        ...
        <div class="ui center inverted black menu large">
            <div class="ui header black item">Your Favorites</div>
        </div>        
        </div>
        </div>
        <div class="ui green header dividing center aligned large inverted" style="margin: 0;">
                Stones     
        </div>
        <div class="ui grid green inverted stackable relaxed feature segment">
...
<?php
                    ...
                    FROM Product
                    INNER JOIN Favorite ON Product.Id = Favorite.ProductId
                    WHERE Product_Type_Id = 1 AND Favorite.UserId = '$userId'";
...
<?php
                    ...
                    FROM Product
                    INNER JOIN Favorite ON Product.Id = Favorite.ProductId
                    WHERE Product_Type_Id = 2 AND Favorite.UserId = '$userId'";
...
<?php
                    ...
                    FROM Product
                    INNER JOIN Favorite ON Product.Id = Favorite.ProductId
                    WHERE Product_Type_Id = 3 AND Favorite.UserId = '$userId'";
...
<?php
                    ...
                    FROM Product
                    INNER JOIN Favorite ON Product.Id = Favorite.ProductId
                    WHERE Product_Type_Id = 4 AND Favorite.UserId = '$userId'";
